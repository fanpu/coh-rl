...
STATE SAVED: docs/status/{HANDOFF.md,m1-ledger.md,final-findings-*.md} committed + pushed on main (5a5de0e). Task 3 stopped-agent output preserved on origin/wip/task3-scraper (023529c). Memory pointer written.
Viewer 3D polish round: complete (867610a, c414880); merged, 602 tests pass, tree clean after run; controller inspected docs/img/viewer-3d.png (infantry legible, team rings, smooth ground). main pushed. M1 CLOSED except Task 3 (user decision).
